...
// TenantDao is the data access object for the table tenant.
...
// TenantColumns defines and stores column names for the table tenant.
...
// tenantColumns holds the columns for the table tenant.
